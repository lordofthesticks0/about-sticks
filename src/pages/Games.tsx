...
const GAME_CONFIG = [
    ...
    { appId: 367520, title: "Hollow Knight", description: "just cause the second game is number 2 don't mean i can't put the first one here LMAOOOOO like okay, the first one is still a really, really, really,really, really, really,really, really, really,really, really, really,really, really, really,really, really, really, REALLY good game on its own. it's fun mechanically, it's fun story wise, what can i say team cherry cooks i guess" },
